...
async function handleStartOrCancel(ctx) {
  ...
  if (isCancel) {
    ...
    await ctx.reply(
      "Choose an option:",
      telegraf_1.Markup.keyboard([["Application 📝", "My Applications 📋"]])
        .oneTime()
        .resize(),
    );
  }
}
const stage = new scenes_1.Stage([
  questionnaire_scene_1.questionnaireScene,
  userScene_1.userScene,
