...
router.get('/stats', async (req, res) => {
    try {
        const totalSubmissions = await submission_model_1.Submission.countDocuments();
        const approvedSubmissions = await submission_model_1.Submission.countDocuments({ status: 'approved' });
